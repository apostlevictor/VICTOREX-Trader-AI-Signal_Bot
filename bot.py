...
# MT5 Configuration
MT5_ACCOUNT_ID = "200011035"
MT5_PASSWORD = "u14QF3#d"
MT5_SERVER = "https://web.metatrader.app/terminal"
...
def get_account_info(update: Update, context: CallbackContext):
    ...
    try:
        ...
        query.edit_message_text("❌ Error retrieving account information. Please try again later.")
