...
# Configuration (in-code as requested)
...
# Fetch market data for forex
def fetch_forex_data(forex_pair, interval='5min'):
    try:
        # Convert forex pair to Alpha Vantage format (e.g., EURUSD)
...
def generate_signal(forex_pair, expiration_minutes):
    ...
    response = f"{signal_color} {forex_pair} Binary Option Signal\n"
